...
#note :-  To execute first go to terminal and type "pip install requests" then it will be executed
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.configure(bg="#FFF0F2")

        # Label
        self.intro_label = Label(self, text='Welcome to Real Time Currency Convertor', fg='black', relief=tk.RAISED,
